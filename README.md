...
<p align="center">
  ...
  <img src="https://img.shields.io/github/stars/EdsonMacamo/letmeask?label=stars&message=MIT&color=8257E5&labelColor=000000" alt="Stars">
...
```bash
$ git clone https://github.com/EdsonMacamo/letmeask
$ cd letmeask
```
...
$ yarn start
```
O app estará a rodar no seu browser pelo endereço http://localhost:3000.
